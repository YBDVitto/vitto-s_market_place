    ...
    try {
        ...
        if(theoreticalPrice === price) {
            ...
            const session = await stripe.checkout.sessions.create({
                ...
                mode: 'payment',
                success_url: `http://localhost:3000/shop/pay/success-html?session_id={CHECKOUT_SESSION_ID}&checkoutId=${checkoutId}`,
                // se il pagamento va a buon fine l'utente viene reindirizzato a success_url
                cancel_url: `http://localhost:3000/shop/pay/cancel-html?checkoutId=${checkoutId}`,
