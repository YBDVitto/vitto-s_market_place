...
export const getPublicHomepage = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const getPublicHomepageLogged = async (req: AuthRequest, res: Response, next: NextFunction) => {
    const products = await Product.findAll({
        where: {
            userId: {
...
export const postAddToCart = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
        const prodId = req.body.prodId as string
        const product = await Product.findByPk(prodId)
        if(!product) {
...
export const patchUpdateQuantity = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
...
export const deleteFromCart = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
...
export const getCheckout = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
        ...
        const cartIdFromCheckout = req.query.cartId as string
...
export const postPayment = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
        ...
        if(theoreticalPrice === price) {
            ...
            const session = await stripe.checkout.sessions.create({
                ...
                mode: 'payment',
                success_url: `https://vitto-s-market-place.vercel.app/html/shop/payment-success?session_id={CHECKOUT_SESSION_ID}&checkoutId=${checkoutId}`,
                // se il pagamento va a buon fine l'utente viene reindirizzato a success_url
                cancel_url: `https://vitto-s-market-place.vercel.app/html/shop/payment-fail?checkoutId=${checkoutId}`,
...
export const postPaymentSuccess = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
        ...
        if(status === 'paid') {
            ...
            return res.status(200).json({
                message:
                'Successful payment! Cart and Checkout deleted.'
            })
        }
    } catch (err: any) {
...
export const postPaymentFail = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
        return res.status(400).json({
...
export const getSpeakDescription = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
...
export const getSearchedUser = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
